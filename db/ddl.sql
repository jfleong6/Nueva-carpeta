...
CREATE TABLE core.clientes ( id serial4 NOT NULL, nombre_completo text NOT NULL, tipo_documento text NULL, numero_documento text NULL, fecha_nacimiento date NULL, sexo text NULL, telefono text NULL, email text NULL, direccion text NULL, ciudad text NULL, departamento text NULL, pais text NULL, notas text NULL, fecha_registro timestamp DEFAULT CURRENT_TIMESTAMP NULL, activo bool DEFAULT true NULL, CONSTRAINT clientes_numero_documento_key UNIQUE (numero_documento), CONSTRAINT clientes_pkey PRIMARY KEY (id));
...
CREATE TABLE core.tipos_pagos ( id serial4 NOT NULL, nombre text NOT NULL, activo bool DEFAULT true NULL, CONSTRAINT tipos_pagos_pkey PRIMARY KEY (id));
...
CREATE TABLE core.usuarios ( id serial4 NOT NULL, nombre text NOT NULL, email text NOT NULL, rol text NULL, activo bool DEFAULT true NULL, CONSTRAINT usuarios_email_key UNIQUE (email), CONSTRAINT usuarios_pkey PRIMARY KEY (id));
...
CREATE TABLE hotel.grupos_hotel ( id serial4 NOT NULL, nombre_grupo varchar(100) NULL, tipo_cuenta varchar(20) NOT NULL, CONSTRAINT grupos_hotel_pkey PRIMARY KEY (id), CONSTRAINT grupos_hotel_tipo_cuenta_check CHECK (((tipo_cuenta)::text = ANY ((ARRAY['grupal'::character varying, 'individual'::character varying])::text[]))));
...
CREATE TABLE hotel.habitaciones ( id serial4 NOT NULL, numero varchar(20) NULL, tipo varchar(50) NULL, capacidad int4 NULL, precio_noche numeric(10, 2) NULL, cama int2 DEFAULT 0 NULL, sencilla int2 DEFAULT 0 NULL, camarote int2 DEFAULT 0 NULL, estado varchar(10) DEFAULT '1'::character varying NULL, activo bool DEFAULT true NULL, CONSTRAINT habitaciones_numero_key UNIQUE (numero), CONSTRAINT habitaciones_pkey PRIMARY KEY (id));
...
CREATE TABLE hotel.movimientos_inventario_hotel ( id serial4 NOT NULL, producto_id int4 NULL, tipo varchar(10) NULL, cantidad int4 NULL, fecha timestamp DEFAULT CURRENT_TIMESTAMP NULL, referencia varchar(100) NULL, CONSTRAINT movimientos_inventario_hotel_pkey PRIMARY KEY (id), CONSTRAINT movimientos_inventario_hotel_tipo_check CHECK (((tipo)::text = ANY ((ARRAY['entrada'::character varying, 'salida'::character varying, 'traslado'::character varying])::text[]))));
...
CREATE TABLE hotel.servicios_combo ( id serial4 NOT NULL, nombre varchar(100) NOT NULL, descripcion text NULL, precio numeric(10, 2) NOT NULL, es_por_persona bool DEFAULT true NULL, CONSTRAINT servicios_combo_pkey PRIMARY KEY (id));
...
CREATE TABLE hotel.reservas_hotel ( id serial4 NOT NULL, cliente_id int4 NULL, habitacion_id int4 NULL, grupo_id int4 NULL, fecha_entrada timestamp NULL, fecha_salida timestamp NULL, estado varchar(20) DEFAULT 'reservada'::character varying NULL, total numeric(10, 2) NULL, CONSTRAINT reservas_hotel_estado_check CHECK (((estado)::text = ANY ((ARRAY['reservada'::character varying, 'confirmada'::character varying, 'cancelada'::character varying])::text[]))), CONSTRAINT reservas_hotel_pkey PRIMARY KEY (id), CONSTRAINT reservas_hotel_grupo_id_fkey FOREIGN KEY (grupo_id) REFERENCES hotel.grupos_hotel(id), CONSTRAINT reservas_hotel_habitacion_id_fkey FOREIGN KEY (habitacion_id) REFERENCES hotel.habitaciones(id));
...
CREATE TABLE hotel.servicios_combo_detalle ( id serial4 NOT NULL, combo_id int4 NOT NULL, beneficio text NOT NULL, orden int4 DEFAULT 1 NULL, CONSTRAINT servicios_combo_detalle_pkey PRIMARY KEY (id), CONSTRAINT servicios_combo_detalle_combo_id_fkey FOREIGN KEY (combo_id) REFERENCES hotel.servicios_combo(id) ON DELETE CASCADE);
...
CREATE TABLE hotel.ventas_hotel ( id serial4 NOT NULL, reserva_id int4 NULL, cliente_id int4 NULL, usuario_id int4 NULL, total numeric(10, 2) NULL, fecha timestamp DEFAULT CURRENT_TIMESTAMP NULL, estado varchar(30) DEFAULT 'completada'::character varying NULL, CONSTRAINT ventas_hotel_pkey PRIMARY KEY (id), CONSTRAINT ventas_hotel_reserva_id_fkey FOREIGN KEY (reserva_id) REFERENCES hotel.reservas_hotel(id));
...
CREATE TABLE hotel.consumos_hotel ( id serial4 NOT NULL, reserva_id int4 NULL, producto_id int4 NULL, cantidad int4 NULL, precio_unitario numeric(10, 2) NULL, fecha timestamp NULL, CONSTRAINT consumos_hotel_pkey PRIMARY KEY (id), CONSTRAINT consumos_hotel_reserva_id_fkey FOREIGN KEY (reserva_id) REFERENCES hotel.reservas_hotel(id));
...
CREATE TABLE hotel.detalle_venta_hotel ( id serial4 NOT NULL, venta_id int4 NULL, producto_id int4 NULL, cantidad int4 NULL, precio_unitario numeric(10, 2) NULL, CONSTRAINT detalle_venta_hotel_pkey PRIMARY KEY (id), CONSTRAINT detalle_venta_hotel_venta_id_fkey FOREIGN KEY (venta_id) REFERENCES hotel.ventas_hotel(id));
...
CREATE TABLE hotel.pagos_hotel ( id serial4 NOT NULL, venta_id int4 NULL, tipo_pago_id int4 NULL, monto numeric(10, 2) NULL, fecha timestamp DEFAULT CURRENT_TIMESTAMP NULL, CONSTRAINT pagos_hotel_pkey PRIMARY KEY (id), CONSTRAINT pagos_hotel_venta_id_fkey FOREIGN KEY (venta_id) REFERENCES hotel.ventas_hotel(id));
...
CREATE TABLE hotel.registro_huesped ( id serial4 NOT NULL, reserva_id int4 NULL, nombre_completo varchar(100) NULL, tipo_documento varchar(20) NULL, numero_documento varchar(30) NULL, nacionalidad varchar(50) NULL, fecha_nacimiento date NULL, sexo varchar(10) NULL, telefono varchar(20) NULL, email varchar(100) NULL, fecha_ingreso timestamp NULL, fecha_salida timestamp NULL, es_principal bool DEFAULT false NULL, observaciones text NULL, CONSTRAINT registro_huesped_pkey PRIMARY KEY (id), CONSTRAINT registro_huesped_reserva_id_fkey FOREIGN KEY (reserva_id) REFERENCES hotel.reservas_hotel(id));
...
CREATE TABLE hotel.servicios_combo_asignado ( id serial4 NOT NULL, registro_huesped_id int4 NOT NULL, combo_id int4 NOT NULL, cantidad_personas int4 DEFAULT 1 NULL, precio_total numeric(10, 2) NOT NULL, CONSTRAINT servicios_combo_asignado_pkey PRIMARY KEY (id), CONSTRAINT servicios_combo_asignado_combo_id_fkey FOREIGN KEY (combo_id) REFERENCES hotel.servicios_combo(id), CONSTRAINT servicios_combo_asignado_registro_huesped_id_fkey FOREIGN KEY (registro_huesped_id) REFERENCES hotel.registro_huesped(id));
